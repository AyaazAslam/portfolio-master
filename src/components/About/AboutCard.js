      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hi Everyone, I am <span className="purple">Ayaz Aslam </span>
            from <span className="purple"> Alipur, Pakistan.</span>
            <br /> <br />
            I am currently Working as a Flutter Development Technology.As a self-taught
            Andriod Developer | React Developer I specialize in modern web
            technologies, including React Node Express JS and MongoDB.
            <br /> <br />
            I have completed (ICS) in Maths and Computer at Star Group of
            College Alipur.
            <br /> <br />
